              ...
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <li class="user-header text-bg-primary">
                  ...
                  <p>
                    ...
                    <small>Staff NOC sejak Nov 2025</small>
                  </p>
                </li>
                <!--end::User Image-->
                <!--begin::Menu Body-->
                ...
                <li class="user-footer">
                  <a href="<?= base_url('users/profile') ?>" class="btn btn-outline-secondary">Profile</a>
                  <a href="<?= base_url('user_auth/logout'); ?>" class="btn btn-outline-danger float-end">Sign out</a>
                </li>
                <!--end::Menu Footer-->
              </ul>
            </li>
