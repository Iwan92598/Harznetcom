...
<div class="text-center mb-4">
  <h2 class="mb-2">Pilih paket wifi mu sesuai kebutuhan</h2>
  <p class="text-secondary mb-0">
    Internet cepat melesat
  </p>
</div>
...
<div class="card">
  <div class="card-header">
    <h3 class="card-title">Penjelasan Fitur</h3>
  </div>
    ...
    <div class="table-responsive">
      <table class="table mb-0 align-middle">
        ...
        <tbody>
          ...
          <tr>
            <td>Browsing, Streaming, Gaming</td>
          ...
          <tr>
            <td>Keluarga Besar, Kantor Kecil</td>
            <td class="text-center">
          ...
          <tr>
            <td>Keluarga Besar, Bekerja dari rumah, Smart Home</td>
            <td class="text-center">
              <i class="bi bi-x-lg text-secondary" aria-hidden="true"></i>
              <span class="visually-hidden">No</span>
            </td>
