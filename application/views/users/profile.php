  ...
  <div class="col-md-3">
    ...
    <div class="card">
      <div class="card-body text-center">
        ...
        <h3 class="h5 mb-0"><?= $this->session->userdata('nama'); ?></h3>
        <p class="text-secondary mb-3"><?= ucfirst($this->session->userdata('level')); ?></p>
        <ul class="list-group list-group-flush text-start small">
          <li class="list-group-item d-flex justify-content-between px-0">
            <span class="text-secondary">Nomor Hp</span>
            <span class="fw-semibold"><?= $this->session->userdata('nohp'); ?></span>
          </li>
          <li class="list-group-item d-flex justify-content-between px-0">
          ...
          <!-- <li class="list-group-item d-flex justify-content-between px-0">
            ...
            <span class="fw-semibold"><?= $this->session->userdata('id_paket'); ?></span>
          </li> -->
        </ul>
